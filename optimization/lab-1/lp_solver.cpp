...
void solveLP()
{
    ...
    A(0, 0) =   1; A(0, 1) =  -1; A(0, 2) =   1; A(0, 3) = -1; A(0, 4) =  7;
    A(1, 0) =   1; A(1, 1) =  -2; A(1, 2) =  17; A(1, 3) = 41; A(1, 4) =  8;
    A(2, 0) = -31; A(2, 1) = -13; A(2, 2) = -11; A(2, 3) = -2; A(2, 4) = -7;
    A(3, 0) =   1; A(3, 1) =   2; A(3, 2) =   3; A(3, 3) =  4; A(3, 4) =  5;
